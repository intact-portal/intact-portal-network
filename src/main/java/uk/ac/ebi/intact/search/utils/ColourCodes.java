...
public class ColourCodes {
    ...
    public static final String SPECIES_TAXID_562 = "rgb(144, 163, 198)"; // Escherichia coli, Color:Orange
    public static final String SPECIES_TAXID_2 = "rgb(141, 102, 102)"; // chemical synthesis , Color: Pink
    public static final String SPECIES_TAXID_OTHERS = "rgb(173, 188, 148)"; // Others, Color: Peach Orange
